...
export default function EditClassTrainer() {
    ...
    useEffect(() => {
        async function fetchClassData() {
            try {
                ...
                notifyError('Failed to load class details!');
            }
        }
        fetchClassData();
    }, [id]);
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            await fetch(`http://localhost:8080/api/classes/${id}`, {
                method: 'PUT',
            ...
            setTimeout(() => navigate('/view-schedule-trainer'), 1500);
        } catch  {
            ...
            <div className="container">
                ...
                <div className="main">
                    <div className="info-banner">
                        <h1 style={{ margin: 0 }}>Edit Fitness Class</h1>
                        <p style={{ marginTop: '0.5rem', color: '#4b5563' }}>
                            Modify the details of the fitness class below and click Update when finished.
                        </p>
                    </div>
                    ...
                    <form className="form-container" onSubmit={handleSubmit}>
                        ...
                        <button type="submit" className="add-button">Update Class</button>
                    </form>
                </div>
            </div>
        </>
